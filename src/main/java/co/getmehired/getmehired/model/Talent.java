...
public class Talent {
	...
	public Immigration getImmigrationStatus() {
		return immigrationStatus;
	}
	public void setImmigrationStatus(Immigration immigrationStatus) {
		this.immigrationStatus = immigrationStatus;
	}
	public Degree getAccademicDegree() {
		return accademicDegree;
	}
	public void setAccademicDegree(Degree accademicDegree) {
	...
	public Support getSuuportNeeded() {
		return suuportNeeded;
	}
	public void setSuuportNeeded(Support suuportNeeded) {
	...
	public EmploymentStatus getEmploymentStart() {
		return employmentStart;
	}
	public void setEmploymentStart(EmploymentStatus employmentStart) {
